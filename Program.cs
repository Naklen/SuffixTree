...
namespace SuffixTree
{
    class Program
    {
        ...
        //Reference pair позволяет представить 
        //некончающийся в листе суффикс
        //в неявном суффиксном дереве
        //Reference pair представляет 
        //собой пару вида [вершина, [начало, конец]]
        //Вершина - это вершина, до которой 
        //нужно дочитать начало суффикса, а начало и конец - это
        //индексы начала и конца подстроки заданной 
        //строки, которые представляют конец суффикса
        ...
        //Выполняет проверку возможности перехода 
        //по символу из состояния [v, [start, end]]
        //по символу с
